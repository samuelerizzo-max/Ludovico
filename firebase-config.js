// ⚠️ QUESTO È L'UNICO FILE CHE DEVI MODIFICARE ⚠️
//
// Incolla qui sotto la configurazione del tuo progetto Firebase.
// La trovi in: console Firebase → icona ingranaggio ⚙️ → Impostazioni progetto
// → scorri fino a "Le tue app" → app web → "Configurazione SDK" → "Config"
//
