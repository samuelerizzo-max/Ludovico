...
function GiftCard({ item, settings, isAdmin, onReserve, onContribute, onUnreserve, onToggleComplete, onEdit, onDelete }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    status === "open" && mode === null && /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2 mt-1" }, item.productUrl && /* @__PURE__ */ React.createElement(
      "button",
      {
    ...
    ), isAdmin && item.price == null && /* @__PURE__ */ React.createElement("button", { onClick: () => onToggleComplete(item.id, true), className: "text-xs underline w-full text-left mt-1", style: { color: C.textMuted } }, "segna come completato")),
    mode === "reserve" && /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-2 mt-1 p-3 rounded-xl", style: { backgroundColor: C.linen } }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-medium", style: { color: C.textMuted } }, "Il tuo nome (facoltativo)"), /* @__PURE__ */ React.createElement(
      "input",
      {
        value: name,
    ...
    ), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 mt-1" }, /* @__PURE__ */ React.createElement("button", { onClick: submitReserve, className: "flex-1 px-3 py-2 rounded-lg text-sm font-semibold", style: { backgroundColor: C.ink, color: C.textOnInk } }, "Conferma e apri il sito"), /* @__PURE__ */ React.createElement("button", { onClick: closeForm, className: "px-3 py-2 rounded-lg text-sm", style: { color: C.textMuted } }, "Annulla"))),
    mode === "contribute" && /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-2 mt-1 p-3 rounded-xl", style: { backgroundColor: C.linen } }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-medium", style: { color: C.textMuted } }, "Il tuo nome (facoltativo)"), /* @__PURE__ */ React.createElement(
      "input",
      {
        value: name,
        onChange: (e) => setName(e.target.value),
    ...
    ), Number(amount) > 0 && /* @__PURE__ */ React.createElement("p", { className: "text-xs", style: { color: C.sage } }, "\u2248 ", Math.round(Number(amount) * (settings.eurRate || 0)), " \u20AC circa"), /* @__PURE__ */ React.createElement("p", { className: "text-xs", style: { color: C.textMuted } }, "Il contributo viene segnato come inviato quando confermi. Il pagamento vero e proprio avviene su PayPal."), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 mt-1" }, /* @__PURE__ */ React.createElement(
      "button",
      {
...
function AdminPanel({ settings, items, initialEditItem, onClose, onSaveSettings, onAddItem, onUpdateItem, onDeleteItem }) {
  ...
  const saveGeneral = () => onSaveSettings({ ...settings, babyName, dueLabel, welcomeMessage, paypalHandle, currency, eurRate: Number(eurRate) || 0 });
  const ledger = [];
  items.forEach((it) => {
    if (it.reservedBy) {
